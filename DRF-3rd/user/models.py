...
class User(AbstractBaseUser):
    username = models.CharField('사용자 계정', max_length=20, unique=True, null=True)
    email = models.EmailField('이메일 주소', max_length=100)
    password = models.CharField('비밀번호', max_length=256)
    fullname = models.CharField('이름', max_length=20, null=True, blank=True)
...
class UserProfile(models.Model):
    ...
    phone_number = PhoneNumberField('전화번호', unique=True, null=True, blank=True)
    ...
    gender = models.CharField('성별', max_length=20, choices=GENDER_CHOICES, null=True, blank=True)
